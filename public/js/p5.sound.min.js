      ...
      void 0 ===
        (r = function (u) {
          ...
          return (
            ...
            (u.TimelineSignal.Type = { Linear: "linear", Exponential: "exponential", Target: "target", Curve: "curve", Set: "set" }),
            ...
            (u.TimelineSignal.prototype.setValueAtTime = function (t, e) {
              return (t = this._fromUnits(t)), (e = this.toSeconds(e)), this._events.add({ type: u.TimelineSignal.Type.Set, value: t, time: e }), this._param.setValueAtTime(t, e), this;
            }),
            (u.TimelineSignal.prototype.linearRampToValueAtTime = function (t, e) {
              return (t = this._fromUnits(t)), (e = this.toSeconds(e)), this._events.add({ type: u.TimelineSignal.Type.Linear, value: t, time: e }), this._param.linearRampToValueAtTime(t, e), this;
            }),
            (u.TimelineSignal.prototype.exponentialRampToValueAtTime = function (t, e) {
              ...
              return (
                ...
                t < this._minOutput ? (this._param.exponentialRampToValueAtTime(this._minOutput, e - this.sampleTime), this.setValueAtTime(0, e)) : this._param.exponentialRampToValueAtTime(t, e),
                this
              );
            }),
            ...
            (u.TimelineSignal.prototype.setValueCurveAtTime = function (t, e, n, i) {
              ...
              (e = this.toSeconds(e)), (n = this.toSeconds(n)), this._events.add({ type: u.TimelineSignal.Type.Curve, value: r, time: e, duration: n }), this._param.setValueAtTime(r[0], e);
          ...
          return (
            ...
            (n.Gain = function () {
              ...
              (this.input = this.output = this._gainNode = this.context.createGain()),
                (this.gain = new n.Param({ param: this._gainNode.gain, units: t.units, value: t.gain, convert: t.convert })),
                this._readOnly("gain");
            }),
            n.extend(n.Gain),
        ...
        (r = function (r) {
          ...
          return (
            ...
            (r.Clock.prototype.start = function (t, e) {
              return (t = this.toSeconds(t)), this._state.getValueAtTime(t) !== r.State.Started && this._state.add({ state: r.State.Started, time: t, offset: e }), this;
            }),
        ...
        (r = function (i) {
          ...
          return (
            ...
            (i.SignalBase.prototype.connect = function (t, e, n) {
              return (
                (i.Signal && i.Signal === t.constructor) || (i.Param && i.Param === t.constructor) || (i.TimelineSignal && i.TimelineSignal === t.constructor)
              ...
              .then(function (t) {
                var n = {
                    ...
                    registerProcessor: function (t, e) {
                      h(r.$$context)[t] = { realm: i, context: n, Processor: e, properties: e.parameterDescriptors || [] };
                    },
                  },
                  i = new (function (t, e) {
        ...
        (r = function (u) {
          ...
          return (
            ...
            (u.Expr._Expressions = {
              ...
              unary: { "-": { regexp: /^\-/, method: i.bind(this, u.Negate) }, "!": { regexp: /^\!/, method: i.bind(this, u.NOT) } },
            }),
                ...
                s(t) && (t = 5),
                  (e =
                    t < 0
                      ...
                      : a(t - 1));
                for (var n = i.peek(); o(n, "binary", t); ) (e = { operator: (n = i.next()).value, method: n.method, args: [e, a(t - 1)] }), (n = i.peek());
                return e;
              }
              return a();
            }),
  ...
  function (t, e, n) {
      ...
      : (x = (function () {
          function i(t, e, n) {
            b(this, i),
              ...
              1 < n
                ? ((this.splitter = S.createChannelSplitter(2)), this.input.connect(this.splitter), this.splitter.connect(this.left, 1), this.splitter.connect(this.right, 0))
        ...
        (function (t, e, n) {
            ...
            value: function (t, e, n, i, r) {
              if (this.output) {
                var o,
                  s,
                  a = t || 0;
                if ((a < 0 && (a = 0), (a += p.audiocontext.currentTime), void 0 !== e && this.rate(e), void 0 !== n && this.setVolume(n), !this.buffer))
                  throw "not ready to play file, buffer has yet to load. Try preload()";
                if (
                  ((this._pauseTime = 0),
                  "restart" === this.mode && this.buffer && this.bufferSourceNode && (this.bufferSourceNode.stop(a), this._counterNode.stop(a)),
                  ...
                  (r = r && (r <= this.buffer.duration - o ? r : this.buffer.duration)),
                    this._paused
                      ? (this.bufferSourceNode.start(a, this.pauseTime, r), this._counterNode.start(a, this.pauseTime, r))
                    ...
                    !0 === this._looping &&
                      ((s = r || o - 1e-15), (this.bufferSourceNode.loopStart = o), (this.bufferSourceNode.loopEnd = s), (this._counterNode.loopStart = o), (this._counterNode.loopEnd = s));
                }
              }
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.isPlaying() && this.buffer && this.bufferSourceNode
                ? ((this._paused = !0), (this._playing = !1), (this.pauseTime = this.currentTime()), this.bufferSourceNode.stop(e), this._counterNode.stop(e), (this._pauseTime = this.currentTime()))
                : (this._pauseTime = 0);
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.reversed = !this.reversed), this.isPlaying() && t && this.jump(this.duration() - t), this.setVolume(e, 0.001);
            },
          },
          {
            key: "onended",
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                (n._workletNode = new AudioWorkletNode(R, s.a.soundFileProcessor, { processorOptions: { bufferSize: r } })),
      ...
      return (
        (function (t, e, n) {
            ...
            value: function (t, e) {
              p.meter.disconnect(),
                ...
                null == t
                  ? p.meter.connect(this._workletNode)
                  : t
                  ? (t.connect(this._workletNode), this._workletNode.disconnect(), this._workletNode.connect(this.output))
                  : p.meter.connect(this._workletNode);
            },
          },
          {
          ...
          },
          {
            key: "toggleNormalize",
            value: function (t) {
              (this.normalize = "boolean" == typeof t ? t : !this.normalize), this._workletNode.port.postMessage({ name: "toggleNormalize", normalize: this.normalize });
            },
          },
          {
            key: "smooth",
          ...
          (function (t, e, n) {
            ...
            },
            {
              ...
              value: function (t) {
                var e = p5.prototype.map(t, 0, 1, 0, 1 / this.f),
                  n = p.audiocontext.currentTime;
                (this.phaseAmount = t),
                  this.dNode || ((this.dNode = p.audiocontext.createDelay()), this.oscillator.disconnect(), this.oscillator.connect(this.dNode), this.dNode.connect(this.output)),
            ...
            },
            {
              ...
              value: function (t, e, n, i) {
                var r, o;
                o = 4 === arguments.length ? ((r = p5.prototype.map(n, t, e, 0, 1) - 0.5), p5.prototype.map(i, t, e, 0, 1) - 0.5) : ((r = t), e);
                var s = new G.a(r, o);
    ...
    (p5.Envelope = function (t, e, n, i, r, o) {
      ...
      (p5.Envelope.prototype.triggerAttack = function (t, e) {
        ...
        !0 === this.isExponential ? this.control.exponentialRampToValueAtTime(this.checkExpInput(i), n) : this.control.linearRampToValueAtTime(i, n),
          ...
          !0 === this.isExponential
            ...
            : (this.control.linearRampToValueAtTime(this.aLevel, n), (i = this.control.getValueAtTime(n)), this.control.cancelScheduledValues(n), this.control.linearRampToValueAtTime(i, n)),
          (n += this.dTime),
          !0 === this.isExponential
            ? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.dLevel), n),
              ...
              this.control.cancelScheduledValues(n),
              this.control.exponentialRampToValueAtTime(i, n))
            : (this.control.linearRampToValueAtTime(this.dLevel, n), (i = this.control.getValueAtTime(n)), this.control.cancelScheduledValues(n), this.control.linearRampToValueAtTime(i, n));
      }),
          ...
          !0 === this.isExponential ? this.control.exponentialRampToValueAtTime(this.checkExpInput(i), n) : this.control.linearRampToValueAtTime(i, n),
            ...
            !0 === this.isExponential
              ? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.rLevel), n),
                ...
                this.control.cancelScheduledValues(n),
                this.control.exponentialRampToValueAtTime(i, n))
              : (this.control.linearRampToValueAtTime(this.rLevel, n), (i = this.control.getValueAtTime(n)), this.control.cancelScheduledValues(n), this.control.linearRampToValueAtTime(i, n)),
            (this.wasTriggered = !1);
        }
      }),
      (p5.Envelope.prototype.ramp = function (t, e, n, i) {
        ...
        a < o ? (this.control.setTargetAtTime(o, r, this._rampAttackTC), (r += this._rampAttackTime)) : o < a && (this.control.setTargetAtTime(o, r, this._rampDecayTC), (r += this._rampDecayTime)),
        ...
        (function (t, e, n) {
        ...
        })(t, [
          {
            ...
            value: function (t, e, n) {
              ...
              this.output.gain.cancelScheduledValues(o), this.output.gain.linearRampToValueAtTime(u, s + 0.001), this.output.gain.linearRampToValueAtTime(t, a);
            },
          },
          {
            key: "chain",
          ...
          (function (t, e, n) {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  t <= 0 && (t = 1),
                  "number" == typeof t
                    ? (this.biquad.frequency.cancelScheduledValues(this.ac.currentTime + 0.01 + n), this.biquad.frequency.exponentialRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  "number" == typeof t
                    ? ((this.biquad.Q.value = t), this.biquad.Q.cancelScheduledValues(this.ac.currentTime + 0.01 + n), this.biquad.Q.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + n))
    ...
    var ee = (function () {
      function s(t) {
        ...
        !(function (t, e) {
          ...
          (e.bands = []);
        for (var o = 0; o < t; o++)
          (r = o === t - 1 ? ((i = 21e3), 0.01) : 0 === o ? ((i = 100), 0.1) : ((i = 1 === o ? (3 === t ? 360 * n : 360) : e.bands[o - 1].freq() * n), 1)),
            ...
            value: function (t, e, n, i, r, o, s) {
              return (
                3 === arguments.length || 4 === arguments.length
                  ...
                  : (6 !== arguments.length && 7 !== arguments) || (this.orientForward(t, e, n), this.orientUp(i, r, o, s)),
    ...
    var Ae = (function () {
        function e() {
          var t;
          return ge(this, e), (t = we(this, Se(e).call(this)))._initConvolverNode(), (t.input.gain.value = 0.5), (t._seconds = 3), (t._decay = 2), (t._reverse = !1), t._buildImpulse(), t;
        }
        return (
          ke(e, Ct),
          Te(e, [
      ...
      Oe = (function () {
        function r(t, e, n) {
          ...
          return (
            ...
            t ? ((i.impulses = []), i._loadBuffer(t, e, n)) : ((i._seconds = 3), (i._decay = 2), (i._reverse = !1), i._buildImpulse()),
            (i.impulses = []),
            (i.set = null),
            i
          );
          ...
          },
          {
            ...
            value: function () {
              return "number" == typeof this._interval
                ...
                ? ((this.musicalTimeMode = !0), (this._bpm / 60 / this._convertNotation(this._interval)) * (this._timeSignature / 4))
                : void 0;
            },
          },
          {
        ...
        })(r, [
          {
            ...
            value: function (t) {
              ...
              e > this.cutoff && e > this.threshold && 0 < e - this.penergy
                ? (this._onPeak(), (this.isDetected = !0), (this.cutoff = e * this.cutoffMult), (this.framesSinceLastPeak = 0))
                : ((this.isDetected = !1),
                  this.framesSinceLastPeak <= this.framesPerPeak ? this.framesSinceLastPeak++ : ((this.cutoff *= this.decayRate), (this.cutoff = Math.max(this.cutoff, this.threshold)))),
                (this.currentValue = e),
                (this.penergy = e);
            },
          },
    ...
    var bn = (function () {
      ...
      return (
        (function (t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
          (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), e && gn(t, e);
        })(e, fn),
        (function (t, e, n) {
